...
PYTHONPATH=. python scripts/cache_geotoken_phase_b_worlds.py --recal3r-root <RECAL_ROOT> --output-root <CAUSAL_ROOT> --trajectory-ids-json <SELECTED_IDS_JSON> --voxel-size 0.02
