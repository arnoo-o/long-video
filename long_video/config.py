...
class SightlineConfig:
    ...
    lora_layers:tuple[int,...]; lora_rank:int; lora_scope:str; memory_pool:int; memory_budget:int; memory_tau_pos:float; memory_tau_angle:float; lambda_corr:float; lambda_corr_final:float; lambda_rgbd:float; lambda_camera_fm:float; m_geo:float; tau_geo:float; max_intra_corr_rows:int
