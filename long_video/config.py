...
def load_sightline_config(path: str|Path) -> SightlineConfig:
    ...
    if (raw['p1_steps'],raw['p2_steps'],raw['p3_steps'])!=(400,600,1500) or raw['ddp_world_size'] not in (2,4) or raw['checkpoint_every']!=100 or raw['diagnostics_frequency']!=5: raise ValueError('formal schedule must be P1/P2/P3=400/600/1500, DDP=2 or 4, metrics=5, checkpoint=100')
