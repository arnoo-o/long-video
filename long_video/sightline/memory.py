...
class LongTermKVMemory:
    ...
    def append_native_attention(self,attn,key,value,rotary_emb,rotary_apply,*,current_chunk,current_global_start,timestamp_embedding=None,sightline_projector=None,scale_delta=None,query_camera_poses=None,native_history_chunk_ids=(),effective_geometry_scale=None,geometry_enabled=True,native_k_rms=None,**kwargs):
        ...
        if sightline_projector is not None and geometry_enabled:
            ...
            delta=sightline_projector.project(
                rays.to(hidden),native_mem_k,kind='k',training=sightline_projector.training,
                scale_delta=scale_delta,native_rms=native_k_rms)
