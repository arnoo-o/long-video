...
import torch
SEMANTICS='sightline-v8'; SCHEMA='sightline-checkpoint-v10'
...
def save_runtime_checkpoint(path, trainable, memory, transformer, optimizer, scheduler, step, *, config, helios_fingerprint, layers, memory_config, provenance=None, rng_states=None):
    ...
    payload={'trainable':trainable.state_dict(),'memory':memory.state_dict(),'lora':lora,
        ...
        'rng_cuda':torch.cuda.get_rng_state_all() if torch.cuda.is_available() else None,'rng_states':rng_states,
