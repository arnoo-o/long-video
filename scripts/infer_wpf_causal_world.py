...
def main():
    ...
    p.add_argument('--recal-confidence-threshold', type=float, default=None,
                   help='Deprecated: ReCal uses each valid-grid raw-confidence 35th percentile.')
